...
//////////////////Mail ////////////////////////////
			$message2 = "New Order Placed".$get_pname."\r\n";
				$subject ="Farm Bags - Order Recieved";	//.$get_order_id."\r\n";
				$from ="farmbags@gmail.com";	// $get_empid;//  // from
...
//////////////////Mail ////////////////////////////
			...
			//mysqli_query($conn,"UPDATE product_list SET status='$get_status' WHERE product_id = '$get_product_id'");
					...
					{
							// Wallet Ballance 
							if ($get_wallet >= $get_net_total)
							{
								
							$result5 = mysqli_query($conn,"UPDATE customer_details SET field_3=field_3-'$get_net_total' WHERE email = '$get_cus_email' ");
