...
$result = mysqli_query($conn,"UPDATE product_list SET pname='$get_pname',description='$get_desc', price='$get_price',size='$get_size', stock='$get_stock', specification='$get_spec',
